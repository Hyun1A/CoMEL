...
class CDATMIL_PPL_ER_Trainer(CDATMIL_PPL_FT_Trainer):
    ...
    def observe(self, n_slides, quality, bag, amp_autocast, args, model, criterion, batch_size, label, patch_labels, epoch, train_acc, i):
        with amp_autocast():
            ###############################################
            ############## Bag augmentation ###############
