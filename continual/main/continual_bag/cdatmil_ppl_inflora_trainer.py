...
class CDATMIL_PPL_InfLoRA_Trainer(CDATMIL_PPL_FT_Trainer):
    ...
    def set_optimizer(self, args):
        ...
        if self.current_task == 0:
            ...
            for name, module in self.model.update_modules.items():
                for module_name, params in module.named_parameters():
                    if "down" not in module_name:
                        train_params += [params]
    ...
    def after_task(self):
        self.model.expand_orthogonal_lora()
        self.current_task += 1
